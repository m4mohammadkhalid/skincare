...
var ButterFly = function() {
    ...
    return {
        init: function() {
            ...
            function() {
            ...
            }(), e = $(".header").height(), $(".header").css("height", e),
                function() {
                    "use strict";
                ...
                function() {
                    ...
                    }), e = [], $(window).width() < 991 && jQuery(".dzseth > div, .dzseth .img-cover, .dzseth .seth").each(function(e) {
                ...
                }), $(".full-height").css("height", $(window).height()), i("beauty-care"), i("footer1"), $(".wow").length > 0 && new WOW({
                    boxClass: "wow",
                    animateClass: "animated",
                    offset: 50,
                    mobile: !1
                }).init(), jQuery("body").append('<a href="https://1.envato.market/REnO2" target="_blank" class="bt-buy-now theme-btn"><i class="ti-shopping-cart"></i><span>Buy Now</span></a><a href="https://w3itexperts.ticksy.com" target="_blank" class="bt-support-now theme-btn"><i class="ti-headphone-alt"></i><span>Support</span></a>\x3c!-- Go to www.addthis.com/dashboard to customize your tools --\x3e<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5b221c5e31b4e54b"><\/script>')
        },
        load: function() {
            ! function() {
                "use strict";
            ...
            }), t(".equal-wraper .equal-col"), t(".equal-wraper2 .equal-col"), t(".equal-wraper3 .equal-col"), jQuery(".counter").length && jQuery(".counter").counterUp({
                delay: 10,
                time: 3e3
            })
        }
...
jQuery(document).ready(function() {
    ...
    "use strict";
    ButterFly.load(), ButterFly.init(), setTimeout(function() {
